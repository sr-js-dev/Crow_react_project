                ...
                <nav className="menu">
                    <ul className="menu__list">
                        ...
                        <li id="4" className="menu__item" onClick={this.changeItem}>
                            <Link to={'/task-overview'} className={window.location.pathname === "/task-overview" || window.location.pathname === "/purchase-order-detail" ? 'menu__link menu__link--active' : 'menu__link menu__link'} >
                                <span className="menu__link-img-wrap">
                                    <img src={require("../assets/images/icon-orders.svg")} alt="Orders"/>
                                </span>
                                <span>{trls("Task")}</span>
