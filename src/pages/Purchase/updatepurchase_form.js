...
class Updatepurchaseform extends Component {
    _isMounted = false;
    constructor(props) {
        super(props);
        this.state = {  
    ...
    handleSubmit = (event) => {
        ...
        Axios.post(API.PutInkoop, params, headers)
        .then(result => {
            this.props.onHide();
...
export default connect(mapStateToProps, mapDispatchToProps)(Updatepurchaseform);